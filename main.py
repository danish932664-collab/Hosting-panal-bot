...
# =====================================================
# ✅ TELEGRAM WEBHOOK HANDLER (FINAL – CORRECT)
# =====================================================
...
async def telegram_webhook(request: web.Request):
    try:
        ...
        # Background me update process karo (Telegram timeout safe)
...
async def web_server():
    ...
    async def handle(request):
        return web.Response(text="🚀 Advanced File Host Bot (Webhook Mode)")
...
async def main():
    logger.info("🚀 Starting Advanced File Host Bot (WEBHOOK MODE)...")
    await web_server()
    await asyncio.Event().wait()  # process alive
